...
def logout(
    ...
    db.query(models.Session).where(
        ...
        models.Session.access_token == user_session.session.access_token
    ).delete()
...
def logout_everywhere(
    ...
    db.query(models.Session).where(
        ...
        models.Session.id != user_session.session.id
    ).delete()
...
def reset_password(
    ...
    request_db = (
        ...
        .where(
            ...
            models.EmailRequests.request_token == password_reset_request.reset_token
        )
        .first()
    )

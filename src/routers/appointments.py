...
from ..schemas.appointment import (AppointmentSlot, CreateAppointment, FirstSlot,
...
def update_any_appointment(
    ...
    try:
        ...
        logging.info(f'Failed to remove job: '
...
def cancel_appointment(
    ...
    occupied_slots = db.query(models.AppointmentSlot).where(
        models.AppointmentSlot.occupied_by_appointment == appointment_id
    ).all()

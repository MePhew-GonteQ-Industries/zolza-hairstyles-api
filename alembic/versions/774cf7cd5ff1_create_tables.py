...
def upgrade():
    ...
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text("(now() at time zone('utc'))"), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('occupied_by_appointment', postgresql.UUID(as_uuid=True), nullable=True),
    ...
    sa.ForeignKeyConstraint(['occupied_by_appointment'], ['appointments.id'], use_alter=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('holiday_translations',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('id', postgresql.UUID(as_uuid=True), server_default=sa.text('gen_random_uuid()'), nullable=False),
    sa.Column('event_type', sa.Enum('user_ban', 'user_unban', name='permission_event_type'), nullable=False),
    ...
    sa.Column('performed_at', sa.TIMESTAMP(), server_default=sa.text("(now() at time zone('utc'))"), nullable=False),
    ...
    sa.Column('last_accessed', sa.TIMESTAMP(), server_default=sa.text("(now() at time zone('utc'))"), nullable=False),
    sa.Column('sudo_mode_activated', sa.TIMESTAMP(), nullable=True),
    sa.Column('sudo_mode_expires', sa.TIMESTAMP(), nullable=True),
    sa.Column('first_accessed', sa.TIMESTAMP(), server_default=sa.text("(now() at time zone('utc'))"), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text("(now() at time zone('utc'))"), nullable=False),
    sa.ForeignKeyConstraint(['end_slot_id'], ['appointment_slots.id'], ),
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], ),
    sa.ForeignKeyConstraint(['start_slot_id'], ['appointment_slots.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('last_updated_at', sa.TIMESTAMP(), server_default=sa.text("(now() at time zone('utc'))"), nullable=False),

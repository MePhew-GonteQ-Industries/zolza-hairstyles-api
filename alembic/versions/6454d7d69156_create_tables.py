...
def upgrade():
    ...
    sa.Column('performed_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    ...
    sa.Column('first_accessed', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
